...
if __name__ == '__main__':
	...
	with mirrored_strategy.scope():
		model        = DCGAN()
		model_gopt   = tf.keras.optimizers.legacy.Adam(learning_rate=lr, beta_1=0.2, beta_2=0.5)
		model_copt   = tf.keras.optimizers.legacy.Adam(learning_rate=lr, beta_1=0.2, beta_2=0.5)
